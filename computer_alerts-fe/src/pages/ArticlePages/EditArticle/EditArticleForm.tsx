...
import { Button } from "react-bootstrap"; // Bootstrap components
...
export default function EditArticle({
  ...
  return (
    <div className="edit-article-page">
      ...
      <div className="field">
        <label>Tags</label>
        <select name="Tag" value={formData.tagsTag} onChange={handleTagChanges}>
      ...
      <div className="field">
        ...
        <textarea name="body" value={formData.body} onChange={handleChanges} />
      </div>
